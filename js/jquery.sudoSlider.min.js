...
l&&g.css({borderRadius:O(A,h)})));r&&g.css({opacity:1});H++;setTimeout(function(){P(p,{left:w,top:K},u,ka,c,a);P(g,{opacity:r?0:1,width:q,height:x,left:J,top:B,borderRadius:f&&r&&l?O(A,h):0},u,ka,function(){H--;0==H&&a.callback()},a)},y)})(h(x[g]),A);A+=u/y.length*1.5}}function W(a,b,k,m,y,g,t,r){var l=a.options,A=l.slices,ka=l.speed/2,p=l.ease,l=a.carousel,s=ua(a,b?A:1,b?1:A,!r),z=0,w=c;k?aa(s):h(aa(s.get())).appendTo(l);m&&ba(s);s.each(function(m){m*=ka/A;var l=h(this),s=l.width(),u=l.height(),n=
...
a.callback()},a]),m)});r&&a.goToNext()}function wa(a,b,k){var m=2==k||4==k;k=2==k||3==k?1:-1;var y=a.options,g=y.ease,y=y.speed;if(b){b=a.fromSlides;var h=fa(a,f).hide();h.prependTo(a.carousel);var r=O(h.height(),b.height()),l=O(h.width(),b.width());h.css(m?{left:k*l}:{top:k*r}).show();P(h,{left:0,top:0},y,g,a.callback,a)}else b=fa(a,c),b.prependTo(a.carousel),a.goToNext(),h=a.toSlides,h=-1==k?b:h,r=h.height(),l=h.width(),P(b,m?{left:k*l}:{top:k*r},y,g,a.callback,a)}function Ra(a){var b=xa(a.carousel),
...
this.readyState)a.trigger("load");else if(this.readyState)this.src=this.src;else if(this.complete)a.trigger("load");else if(this.complete===ha){var u=this.src;this.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==";this.src=u}}):c()}else c()}function ob(a){for(var b=h.fn.jquery.split("."),k=b.length,m=0;m<k;m++)if(a[m]&&+b[m]<+a[m])return c;return f}function oa(a){var b=[],c;for(c in a)b.push(c);return b}function w(a){setTimeout(a,0)}function aa(a){return[].reverse.call(a)}
...
function(a,b,f){b++;W(a,2==f||4==f,1==f||4==f,c,c,b)}],fold:function(a,b){W(a,2==b||4==b,1==b||4==b)},push:["Out","In",wa],reveal:function(a,b){var h=1==b||3==b,m=a.options,w=m.ease,m=m.speed,g=fa(a,f),t=g.width(),r=g.height(),l=za(g,0,0,0,0,a).css({opacity:1}).appendTo(a.carousel),u=l.add(g);u.hide();h?(l.css({width:t}),1==b&&(g.css({top:-r}),l.css({bottom:0,top:"auto"}))):(l.css({height:r}),4==b&&(g.css({left:-t}),l.css({right:0,left:"auto"})));u.show();h?u.width(t):u.height(r);P(g,{left:0,top:0},
